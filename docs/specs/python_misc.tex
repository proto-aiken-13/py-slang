...
\begin{itemize}
  \item
    \href{https://sourceacademy.org/sicpjs/1.2.6\#ex_1.22}{\lstinline{time_time()}}:
  ...
  \item \texttt{input(s)}: \textit{primitive}, pops up a window that
    ...
    non-string value.
  \item
    \href{https://sourceacademy.org/sicpjs/1.2.6\#footnote-7}{\texttt{print(...)}}:
    \textit{primitive}, prints its arguments (variadic) in the
    console; returns \texttt{None}.
  \item
