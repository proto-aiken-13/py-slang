...
export function compileCode(
  code: string,
  chapter: number = 4,
): { program: SVMLProgram; instrumentation: InstrumentationTracker; compiler: SVMLCompiler } {
...
export async function runInContext(code: string): Promise<{ result: SVMLBoxType; stdout: string }> {
