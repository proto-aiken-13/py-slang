...
export class SVMLProgram {
  ...
  /** Maps function index → original AST node for AST-level respecialization. */
  readonly functionASTs: ReadonlyMap<number, object>;
  constructor(entryPoint: number, functions: SVMLIR[], functionASTs?: Map<number, object>) {
    this.entryPoint = entryPoint;
    this.functions = Object.freeze([...functions]);
    this.functionASTs = functionASTs ?? new Map();
    Object.freeze(this);
  }
