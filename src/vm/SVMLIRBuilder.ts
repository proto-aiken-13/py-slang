...
export class SVMLIRBuilder {
  ...
  getAllBuildersSorted(): SVMLIRBuilder[] {
    // Bucket sort: all indices are unique in [0, n)
    const builders = new Array<SVMLIRBuilder>(this.getAllBuilders().length);
