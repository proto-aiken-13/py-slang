...
import {
  ...
  type SoundType,
  type AbstractValue,
  INT_BIT, BOOL_BIT, STR_BIT, NULL_BIT, CLOSURE_BIT,
  ALL_KINDS_MASK,
} from "./abstract-value";
...
export function joinIntRef(a: IntRef, b: IntRef): IntRef   { return a | b; }
export function meetIntRef(a: IntRef, b: IntRef): IntRef   { return a & b; }
export function leqIntRef(a: IntRef, b: IntRef): boolean   { return (a & b) === a; }

export function joinBoolRef(a: BoolRef, b: BoolRef): BoolRef { return a | b; }
export function meetBoolRef(a: BoolRef, b: BoolRef): BoolRef { return a & b; }
export function leqBoolRef(a: BoolRef, b: BoolRef): boolean { return (a & b) === a; }
...
export function integer(intRef: IntRef = 7 as IntRef): AbstractValue { return INT_SINGLETONS[intRef]; }
export function positiveInteger(): AbstractValue { return INT_SINGLETONS[4]; } // IntRef.Pos
export function negativeInteger(): AbstractValue { return INT_SINGLETONS[1]; } // IntRef.Neg
export function zeroInteger(): AbstractValue     { return INT_SINGLETONS[2]; } // IntRef.Zero

export function boolean(boolRef: BoolRef = 3 as BoolRef): AbstractValue { return BOOL_SINGLETONS[boolRef]; }
export function trueValue(): AbstractValue  { return BOOL_SINGLETONS[1]; } // BoolRef.True
export function falseValue(): AbstractValue { return BOOL_SINGLETONS[2]; } // BoolRef.False

export function stringValue(): AbstractValue  { return STRING_VAL; }
export function nullValue(): AbstractValue    { return NULL_VAL; }
export function closureValue(): AbstractValue { return CLOSURE_VAL; }
